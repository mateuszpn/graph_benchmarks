...
[[maybe_unused]] static const inline RegisterTestCase<LifecycleCommandList>
    registerTestCase{};

class LifecycleCommandListTest
...
INSTANTIATE_TEST_SUITE_P(LifecycleCommandListTest, LifecycleCommandListTest,
