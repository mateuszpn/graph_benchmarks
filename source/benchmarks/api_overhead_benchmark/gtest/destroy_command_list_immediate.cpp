...
[[maybe_unused]] static const inline RegisterTestCase<
    DestroyCommandListImmediate>
    registerTestCase{};

class DestroyCommandListImmediateTest
...
INSTANTIATE_TEST_SUITE_P(DestroyCommandListImmediateTest,
                         DestroyCommandListImmediateTest,
                         ::testing::Combine(::testing::Values(100, 1000),
