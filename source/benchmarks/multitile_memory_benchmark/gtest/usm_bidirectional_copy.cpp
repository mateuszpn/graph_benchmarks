...
[[maybe_unused]] static const inline RegisterTestCase<UsmBidirectionalCopy>
    registerTestCase{};

class UsmBidirectionalCopyTest
    : public ::testing::TestWithParam<std::tuple<Api, size_t, bool, bool>> {};
...
INSTANTIATE_TEST_SUITE_P(UsmBidirectionalCopyTest, UsmBidirectionalCopyTest,
