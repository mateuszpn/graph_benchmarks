...
[[maybe_unused]] static const inline RegisterTestCase<SeparateAtomicsExplicit>
    registerTestCase{};

class SeparateAtomicsExplicitTest
    : public ::testing::TestWithParam<std::tuple<
          DataType, MathOperation, size_t, AtomicScope, AtomicMemoryOrder,
          CommonGtestArgs::EnqueueSize, bool, TestType>> {};
...
INSTANTIATE_TEST_SUITE_P(
    SeparateAtomicsExplicitTest, SeparateAtomicsExplicitTest,
...
INSTANTIATE_TEST_SUITE_P(
    SeparateAtomicsExplicitExtendedTest, SeparateAtomicsExplicitTest,
    ::testing::Combine(::testing::Values(DataType::Float, DataType::Int32),
