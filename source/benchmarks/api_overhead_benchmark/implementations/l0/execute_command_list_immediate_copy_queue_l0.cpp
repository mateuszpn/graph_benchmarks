...
static TestResult
run(const ExecuteCommandListImmediateCopyQueueArguments &arguments,
  ...
  ASSERT_ZE_RESULT_SUCCESS(zeCommandListAppendMemoryCopy(
      cmdList, dstBuffer, srcBuffer, arguments.size, event, 0, nullptr));
  ...
  ASSERT_ZE_RESULT_SUCCESS(
      UsmHelper::deallocate(arguments.sourcePlacement, levelzero, srcBuffer));
...
static RegisterTestCaseImplementation<ExecuteCommandListImmediateCopyQueue>
