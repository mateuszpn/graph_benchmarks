...
[[maybe_unused]] static const inline RegisterTestCase<
    NewResourcesSubmissionDevice>
    registerTestCase{};

class NewResourcesSubmissionDeviceTest
...
INSTANTIATE_TEST_SUITE_P(
    NewResourcesSubmissionDeviceTest, NewResourcesSubmissionDeviceTest,
    ::testing::Combine(::CommonGtestArgs::allApis(),
                       ::testing::Values(1, 64 * kiloByte, 512 * kiloByte,
                                         1 * megaByte, 16 * megaByte,
                                         64 * megaByte, 256 * megaByte,
                                         1 * gigaByte)));
