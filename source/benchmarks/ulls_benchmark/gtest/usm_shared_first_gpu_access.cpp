...
[[maybe_unused]] static const inline RegisterTestCase<UsmSharedFirstGpuAccess>
    registerTestCase{};

class UsmSharedFirstGpuAccessTest
...
INSTANTIATE_TEST_SUITE_P(
    UsmSharedFirstGpuAccessTest, UsmSharedFirstGpuAccessTest,
