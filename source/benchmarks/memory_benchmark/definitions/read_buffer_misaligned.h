...
struct ReadBufferMisalignedArguments : TestCaseArgumentContainer {
  ...
  ReadBufferMisalignedArguments()
      : size(*this, "size", "Size of the buffer"),
        misalignmentFromCacheline(*this, "misalignment",
                                  "Number of bytes by which misaligned the "
                                  "destination pointer will be misaligned"),
...
struct ReadBufferMisaligned : TestCase<ReadBufferMisalignedArguments> {
  ...
  std::string getHelp() const override {
    return "allocates an OpenCL buffer and measures read bandwidth. Read "
           "operation means "
           "transfer from GPU to CPU. Destination pointer passed by the "
           "application will be "
