...
[[maybe_unused]] static const inline RegisterTestCase<UsmSharedFirstCpuAccess>
    registerTestCase{};

class UsmSharedFirstCpuAccessTest
    : public ::testing::TestWithParam<
          std::tuple<Api, UsmInitialPlacement, size_t>> {};
...
INSTANTIATE_TEST_SUITE_P(
    UsmSharedFirstCpuAccessTest, UsmSharedFirstCpuAccessTest,
    ::testing::Combine(::CommonGtestArgs::allApis(),
                       ::testing::Values(UsmInitialPlacement::Any,
                                         UsmInitialPlacement::Host,
                                         UsmInitialPlacement::Device),
