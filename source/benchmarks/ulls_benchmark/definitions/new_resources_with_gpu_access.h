...
struct NewResourcesWithGpuAccess
    : TestCase<NewResourcesWithGpuAccessArguments> {
  ...
  std::string getHelp() const override {
    return "enqueues kernel that accesses an entire buffer placed in device "
           "memory to measure "
           "resource preparation time. The resource is destroyed and recreated "
           "for each "
