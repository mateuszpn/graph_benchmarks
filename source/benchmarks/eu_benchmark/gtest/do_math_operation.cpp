...
[[maybe_unused]] static const inline RegisterTestCase<DoMathOperation>
    registerTestCase{};

class DoMathOperationTest
    : public ::testing::TestWithParam<std::tuple<
          DataType, MathOperation, CommonGtestArgs::EnqueueSize, bool, bool>> {
};
