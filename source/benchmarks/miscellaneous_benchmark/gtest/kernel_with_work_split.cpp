...
[[maybe_unused]] static const inline RegisterTestCase<KernelWithWorkSplit>
    registerTestCase{};

class KernelWithWorkSplitSubmissionTest
    : public ::testing::TestWithParam<
          std::tuple<Api, WorkItemIdUsage, size_t, size_t, size_t, bool>> {};
...
INSTANTIATE_TEST_SUITE_P(
    KernelWithWorkSplitSubmissionTest, KernelWithWorkSplitSubmissionTest,
