...
static TestResult run(const RemoteAccessMemoryArguments &arguments,
  ...
  ASSERT_CL_SUCCESS(clSetKernelArg(
      kernel, static_cast<cl_uint>(buffersCount + 1), sizeof(n_th), &n_th));
...
static RegisterTestCaseImplementation<RemoteAccessMemory>
