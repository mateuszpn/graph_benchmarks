...
[[maybe_unused]] static const inline RegisterTestCase<UsmMemoryAllocation>
    registerTestCase{};

class UsmMemoryAllocationTest
    : public ::testing::TestWithParam<std::tuple<
          UsmRuntimeMemoryPlacement, size_t, AllocationMeasureMode>> {};
...
INSTANTIATE_TEST_SUITE_P(
    UsmMemoryAllocationTest, UsmMemoryAllocationTest,
    ::testing::Combine(::testing::Values(UsmRuntimeMemoryPlacement::Host,
                                         UsmRuntimeMemoryPlacement::Device,
                                         UsmRuntimeMemoryPlacement::Shared),
                       ...
                       ::testing::Values(AllocationMeasureMode::Allocate,
                                         AllocationMeasureMode::Free,
                                         AllocationMeasureMode::Both)));
