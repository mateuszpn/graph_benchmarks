  ...
  MpiAllToAllArguments()
      : mpiLauncher(*this, "mpiLauncher",
        ...
        sendType(*this, "sendType",
                 "Memory type of the MPI_Alltoall send buffer"),
        recvType(*this, "recvType",
                 "Memory type of the MPI_Alltoall recv buffer") {
    mpiLauncher = "mpirun";
...
struct MpiAllToAll : public TestCase<MpiAllToAllArguments> {
  ...
  std::string getTestCaseName() const override { return "MpiAllToAll"; }

  std::string getHelp() const override {
    return "Measures the performance of the all-to-all exchange in an MPI+X "
           "application.";
  }
};
