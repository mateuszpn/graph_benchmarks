...
static TestResult run(const OneLocalAtomicExplicitArguments &arguments,
  ...
  const std::string compilerOptions = KernelHelper::getCompilerOptionsExplicit(
      ...
      arguments.scope, otherArgumentsBufferSize);
...
static RegisterTestCaseImplementation<OneLocalAtomicExplicit>
