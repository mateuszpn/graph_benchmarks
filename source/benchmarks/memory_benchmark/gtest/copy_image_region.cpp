...
[[maybe_unused]] static const inline RegisterTestCase<CopyImageRegion>
    registerTestCase{};

using Tuple = ThreeComponentUintArgument::TupleType;
class CopyImageRegionTest
    : public ::testing::TestWithParam<std::tuple<Api, Tuple, bool, bool>> {};
...
INSTANTIATE_TEST_SUITE_P(
    CopyImageRegionTest, CopyImageRegionTest,
