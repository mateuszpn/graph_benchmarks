...
[[maybe_unused]] static const inline RegisterTestCase<CopyBufferRect>
    registerTestCase{};

using Tuple = ThreeComponentUintArgument::TupleType;
class CopyBufferRectTestEntireBuffer
    : public ::testing::TestWithParam<std::tuple<bool, bool, Tuple>> {};
...
INSTANTIATE_TEST_SUITE_P(
    CopyBufferRectTestEntireBuffer, CopyBufferRectTestEntireBuffer,
    ::testing::Combine(
