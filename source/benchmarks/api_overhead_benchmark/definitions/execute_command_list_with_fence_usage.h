...
struct ExecuteCommandListWithFenceUsage
    : TestCase<ExecuteCommandListWithFenceUsageArguments> {
  ...
  std::string getHelp() const override {
    return "measures time spent in zeCommandQueueExecuteCommandLists and "
           "zeFenceSynchronize on CPU when fences are used.";
  }
};
