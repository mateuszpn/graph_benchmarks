...
protected:
  ...
  void parseImpl(const std::string &valueToParse) override {
    ...
    FATAL_ERROR_IF(colonPos1 == std::string::npos,
                   "Too few colons specified for a 3-component vector");
    FATAL_ERROR_IF(colonPos2 == std::string::npos,
                   "Too few colons specified for a 3-component vector");
    FATAL_ERROR_IF(colonPos3 != std::string::npos,
                   "Too many colons specified for a 3-component vector");
