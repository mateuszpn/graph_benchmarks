...
[[maybe_unused]] static const inline RegisterTestCase<CopyEntireImage>
    registerTestCase{};

using ImageSize = ThreeComponentUintArgument::TupleType;
class CopyEntireImageTest
    : public ::testing::TestWithParam<std::tuple<Api, ImageSize, bool, bool>> {
};
...
INSTANTIATE_TEST_SUITE_P(
    CopyEntireImageTest, CopyEntireImageTest,
