...
struct RoundTripSubmission : TestCase<RoundTripSubmissionArguments> {
  ...
  std::string getTestCaseName() const override { return "RoundTripSubmission"; }

  std::string getHelp() const override {
    return "enqueues kernel which updates system memory location and waits for "
           "it with a synchronizing API.";
  }
};
