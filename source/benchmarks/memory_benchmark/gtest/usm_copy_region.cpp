...
[[maybe_unused]] static const inline RegisterTestCase<UsmCopyRegion>
    registerTestCase{};
...
class UsmCopyRegionTest
    : public ::testing::TestWithParam<
          std::tuple<UsmMemoryPlacement, UsmMemoryPlacement, Tuple, Tuple,
                     size_t, BufferContents, bool, bool>> {};
...
INSTANTIATE_TEST_SUITE_P(
    UsmCopyRegionTest, UsmCopyRegionTest,
    ::testing::Combine(
        ::testing::Values(UsmMemoryPlacement::Device, UsmMemoryPlacement::Host),
        ::testing::Values(UsmMemoryPlacement::Device, UsmMemoryPlacement::Host),
        ::testing::Values(Tuple(128, 128, 1), Tuple(128, 128, 128),
                          Tuple(128, 1024, 1024), Tuple(1024, 16, 1024),
                          Tuple(1024, 1024, 16)),
        ::testing::Values(Tuple(0, 0, 0)), ::testing::Values(512 * megaByte),
