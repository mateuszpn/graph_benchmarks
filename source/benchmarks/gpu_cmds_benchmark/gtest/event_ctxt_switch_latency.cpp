...
[[maybe_unused]] static const inline RegisterTestCase<EventCtxtSwitchLatency>
    registerTestCase{};

class EventCtxtSwitchLatencyTest
    : public ::testing::TestWithParam<std::tuple<size_t, Engine, Engine>> {};
...
INSTANTIATE_TEST_SUITE_P(EventCtxtSwitchLatencyTest, EventCtxtSwitchLatencyTest,
                         ::testing::Combine(::testing::Values(500, 1000),
