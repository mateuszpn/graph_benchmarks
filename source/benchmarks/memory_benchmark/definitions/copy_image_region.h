...
struct CopyImageRegion : TestCase<CopyImageRegionArguments> {
  ...
  std::string getTestCaseName() const override { return "CopyImageRegion"; }

  std::string getHelp() const override {
    return "allocates two image objects and measures region copy bandwidth "
           "between them using immediate command list for Level Zero and "
