...
[[maybe_unused]] static const inline RegisterTestCase<RemoteAccessMemory>
    registerTestCase{};

class RemoteAccessMemoryTest
    : public ::testing::TestWithParam<
          std::tuple<Api, StreamMemoryType, size_t, size_t, bool, size_t>> {};
...
INSTANTIATE_TEST_SUITE_P(
    RemoteAccessMemoryTest, RemoteAccessMemoryTest,
    ::testing::Combine(
