...
[[maybe_unused]] static const inline RegisterTestCase<UsmFillImmediate>
    registerTestCase{};

class UsmFillImmediateTest
    : public ::testing::TestWithParam<
          std::tuple<UsmMemoryPlacement, size_t, BufferContents, size_t,
                     BufferContents, bool, bool>> {};
...
INSTANTIATE_TEST_SUITE_P(
    UsmFillImmediateTest, UsmFillImmediateTest,
    ::testing::Combine(
        ::testing::Values(UsmMemoryPlacement::Host, UsmMemoryPlacement::Device,
                          UsmMemoryPlacement::Shared),
        ::testing::Values(512 * megaByte),
        ::testing::Values(BufferContents::Zeros), ::testing::Values(1, 4, 16),
