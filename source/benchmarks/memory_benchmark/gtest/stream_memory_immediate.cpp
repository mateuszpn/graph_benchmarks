...
[[maybe_unused]] static const inline RegisterTestCase<StreamMemoryImmediate>
    registerTestCase{};

class StreamMemoryImmediateTest
...
INSTANTIATE_TEST_SUITE_P(
    StreamMemoryImmediateTest, StreamMemoryImmediateTest,
    ::testing::Combine(
