...
[[maybe_unused]] static const inline RegisterTestCase<SlmSwitchLatency>
    registerTestCase{};

class SlmSwitchLatencyTest
    : public ::testing::TestWithParam<std::tuple<Api, size_t, size_t, size_t>> {
};
...
INSTANTIATE_TEST_SUITE_P(
    SlmSwitchLatencyTest, SlmSwitchLatencyTest,
    ::testing::Combine(::CommonGtestArgs::allApis(),
                       ::testing::Values(1 * kiloByte, 16 * kiloByte,
                                         32 * kiloByte, 64 * kiloByte),
                       ::testing::Values(1 * kiloByte, 16 * kiloByte,
                                         32 * kiloByte, 64 * kiloByte),
