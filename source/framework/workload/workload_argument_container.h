  ...
  WorkloadArgumentContainer()
      : iterations(*this, "iterations", "Number of iterations to perform"),
        synchronize(*this, "synchronize",
                    "Wait for synchronization before each iteration"),
        synchronizationPipeIn(*this, "synchronizationPipeIn",
                              "Handle for the synchronization pipe (parent to "
                              "child). If 0, stdin is used."),
        synchronizationPipeOut(*this, "synchronizationPipeOut",
                               "Handle for the synchronization pipe (child to "
                               "parent). If 0, stdout is used."),
        measurementPipe(
            *this, "measurementPipe",
            "Handle for the measurements pipe. If 0, stdout is used") {
