...
[[maybe_unused]] static const inline RegisterTestCase<MpiBandwidth>
    registerTestCase{};

class MpiBandwidthTest
    : public ::testing::TestWithParam<
          std::tuple<uint32_t, UsmMemoryPlacement, UsmMemoryPlacement, uint32_t,
                     MpiStatisticsType>> {};
...
INSTANTIATE_TEST_SUITE_P(
    MpiBandwidthTest, MpiBandwidthTest,
    ::testing::Combine(
