...
[[maybe_unused]] static const inline RegisterTestCase<QueueInOrderMemcpy>
    registerTestCase{};

class QueueInOrderMemcpyTest
    : public ::testing::TestWithParam<std::tuple<
          Api, UsmMemoryPlacement, UsmMemoryPlacement, size_t, size_t, bool>> {
};
...
INSTANTIATE_TEST_SUITE_P(
    QueueInOrderMemcpyTest, QueueInOrderMemcpyTest,
    ::testing::Combine(::testing::Values(Api::SYCL, Api::L0),
                       ...
                       ::testing::Values(10), ::testing::Values(true, false)));
