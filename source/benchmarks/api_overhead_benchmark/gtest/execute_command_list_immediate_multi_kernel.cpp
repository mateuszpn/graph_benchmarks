...
[[maybe_unused]] static const inline RegisterTestCase<
    ExecuteCommandListImmediateMultiKernel>
    registerTestCase{};

class ExecuteCommandListImmediateMultiKernelTest
    : public ::testing::TestWithParam<
          std::tuple<size_t, size_t, bool, size_t, size_t, bool>> {};
...
INSTANTIATE_TEST_SUITE_P(ExecuteCommandListImmediateMultiKernelTest,
