...
[[maybe_unused]] static const inline RegisterTestCase<CopyImageToBuffer>
    registerTestCase{};

using ImageSize = ThreeComponentUintArgument::TupleType;
class CopyImageToBufferTest
    : public ::testing::TestWithParam<
          std::tuple<Api, UsmMemoryPlacement, size_t, ImageSize, bool, bool>> {
};
...
INSTANTIATE_TEST_SUITE_P(
    CopyImageToBufferTest, CopyImageToBufferTest,
