...
struct UsmFillImmediateArguments : TestCaseArgumentContainer {
  ...
  UsmFillImmediateArguments()
      : usmMemoryPlacement(*this, "memory", "Placement of the buffer"),
        ...
        patternContents(*this, "patternContents",
                        "Select contents of the fill pattern"),
        forceBlitter(*this, "forceBlitter", CommonHelpMessage::forceBlitter()),
        useEvents(*this, "useEvents", CommonHelpMessage::useEvents()) {}
};

struct UsmFillImmediate : TestCase<UsmFillImmediateArguments> {
  using TestCase<UsmFillImmediateArguments>::TestCase;

  std::string getTestCaseName() const override { return "UsmFillImmediate"; }
