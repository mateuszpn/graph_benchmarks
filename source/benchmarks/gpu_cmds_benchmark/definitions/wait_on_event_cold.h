...
struct WaitOnEventCold : TestCase<WaitOnEventColdArguments> {
  ...
  std::string getTestCaseName() const override { return "WaitOnEventCold"; }

  std::string getHelp() const override {
    return "measures time required to service a signalled semaphore, that has "
           "never been waited for.";
  }
};
