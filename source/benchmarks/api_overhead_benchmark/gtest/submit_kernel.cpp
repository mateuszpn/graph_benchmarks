...
[[maybe_unused]] static const inline RegisterTestCase<SubmitKernel>
    registerTestCase{};

class SubmitKernelTest
    : public ::testing::TestWithParam<
          std::tuple<Api, bool, bool, bool, size_t, size_t, bool>> {};
...
INSTANTIATE_TEST_SUITE_P(
    SubmitKernelTest, SubmitKernelTest,
