...
[[maybe_unused]] static const inline RegisterTestCase<EnqueueNdrTime>
    registerTestCase{};

class EnqueueNdrTimeTest : public ::testing::TestWithParam<
...
INSTANTIATE_TEST_SUITE_P(EnqueueNdrTimeTest, EnqueueNdrTimeTest,
