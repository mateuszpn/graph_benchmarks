...
struct CpuAllocationHelper {
  ...
  public:
    AlignedAllocation(std::unique_ptr<std::byte[]> &&rawMemory,
  ...
  public:
    MisalignedAllocation(AlignedAllocation &&alignedAllocation,
  ...
  static AlignedAllocation allocateAlignedAllocation(size_t size,
                                                     size_t alignment);
  static MisalignedAllocation allocateMisalignedAllocation(size_t size,
                                                           size_t alignment,
                                                           size_t misalignment);
};
