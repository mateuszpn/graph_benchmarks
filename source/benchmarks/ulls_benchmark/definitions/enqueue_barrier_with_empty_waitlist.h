...
struct EnqueueBarrierWithEmptyWaitlist
    : TestCase<EnqueueBarrierWithEmptyWaitlistArguments> {
  ...
  std::string getHelp() const override {
    return "enqueues kernel with barriers with empty waitlists inbetween, "
           "waiting on the last barriers event";
  }
};
