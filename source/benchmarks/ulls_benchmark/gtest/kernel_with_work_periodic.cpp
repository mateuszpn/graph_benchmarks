...
[[maybe_unused]] static const inline RegisterTestCase<KernelWithWorkPeriodic>
    registerTestCase{};

class KernelWithWorkPeriodicSubmissionTest
...
INSTANTIATE_TEST_SUITE_P(KernelWithWorkPeriodicSubmissionTest,
