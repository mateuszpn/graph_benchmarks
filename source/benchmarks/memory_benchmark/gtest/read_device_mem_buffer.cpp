...
[[maybe_unused]] static const inline RegisterTestCase<ReadDeviceMemBuffer>
    registerTestCase{};

class ReadDeviceMemBufferTest
...
INSTANTIATE_TEST_SUITE_P(
    ReadDeviceMemBufferTest, ReadDeviceMemBufferTest,
    ::testing::Combine(::testing::Values(64 * kiloByte, 128 * kiloByte,
                                         512 * kiloByte, 1 * megaByte,
                                         4 * megaByte, 16 * megaByte,
                                         32 * megaByte, 64 * megaByte,
                                         128 * megaByte, 256 * megaByte),
