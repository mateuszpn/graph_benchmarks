...
[[maybe_unused]] static const inline RegisterTestCase<FullRemoteAccessMemory>
    registerTestCase{};

class FullRemoteAccessMemoryTest
    : public ::testing::TestWithParam<std::tuple<Api, StreamMemoryType, size_t,
...
INSTANTIATE_TEST_SUITE_P(
    FullRemoteAccessMemoryTest, FullRemoteAccessMemoryTest,
    ::testing::Combine(
        ::CommonGtestArgs::allApis(),
        ::testing::ValuesIn(StreamMemoryTypeArgument::onlyReadAndWrite),
        ::testing::Values(1 * gigaByte), ::testing::Values(1, 2, 4, 8),
        ::testing::Values(true),
