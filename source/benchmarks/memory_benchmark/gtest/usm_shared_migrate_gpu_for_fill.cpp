...
[[maybe_unused]] static const inline RegisterTestCase<
    UsmSharedMigrateGpuForFill>
    registerTestCase{};

class UsmSharedMigrateGpuForFillTest
    : public ::testing::TestWithParam<
          std::tuple<Api, size_t, bool, UsmMemAdvisePreferredLocation, bool>> {
};
...
INSTANTIATE_TEST_SUITE_P(
    UsmSharedMigrateGpuForFillTest, UsmSharedMigrateGpuForFillTest,
