...
[[maybe_unused]] static const inline RegisterTestCase<ModuleCreateSpv>
    registerTestCase{};

class ModuleCreateSpvTest
...
INSTANTIATE_TEST_SUITE_P(ModuleCreateSpvTest, ModuleCreateSpvTest,
                         ::testing::Combine(::testing::Values(
                             "api_overhead_benchmark_write_sum_local.spv",
