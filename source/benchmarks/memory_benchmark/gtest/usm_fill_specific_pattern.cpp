...
[[maybe_unused]] static const inline RegisterTestCase<UsmFillSpecificPattern>
    registerTestCase{};

class UsmFillSpecificPatternTest
    : public ::testing::TestWithParam<
          std::tuple<Api, UsmMemoryPlacement, size_t, BufferContents,
...
INSTANTIATE_TEST_SUITE_P(
    UsmFillSpecificPatternTest, UsmFillSpecificPatternTest,
    ::testing::Combine(
        ::CommonGtestArgs::allApis(),
        ::testing::Values(UsmMemoryPlacement::Host, UsmMemoryPlacement::Device,
                          UsmMemoryPlacement::Shared),
        ::testing::Values(128 * megaByte, 512 * megaByte),
        ::testing::Values(BufferContents::Zeros), ::testing::Values("0x01AA0B"),
