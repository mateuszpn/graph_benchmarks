...
Configuration::Configuration()
    : help(*this, "help", "Shows this message"),
      ...
      l0DeviceIndex(*this, "l0DeviceIndex",
                    "LevelZero device index inside the driver"),
      urPlatformIndex(*this, "urPlatformIndex", "UR adapter index"),
      urDeviceIndex(*this, "urDeviceIndex",
                    "UR device index inside the adapter"),
      test(*this, "test",
           "Selects particular test for execution. All arguments of the test "
           "must be provided"),
      subDeviceSelection(*this, "subDeviceSelection",
                         "Device to be used in the benchmarks. Might be "
                         "ignored by some specific tests"),
      csv(*this, "csv",
          "dump results in CSV format for easy imports to spreadsheets"),
      verbose(*this, "verbose", "dump results from all iterations"),
      interactivePrints(
          *this, "interactivePrints",
          "display test name before running it. May cause unexcpected results "
          "when redirecting output to files."),
      iterations(*this, "iterations",
                 "select how many times each test will be run"),
      selectedApi(*this, "api", "Compute API to be used"),
      noIntelExtensions(
          *this, "no-intel-extensions",
          "do not run benchmark requiring Intel specific extensions"),
      dumpCommandLines(*this, "dumpCommandLines",
                       "output commandline arguments to run the each test"),
      noop(*this, "noop",
           "do not run any tests, only print their names and parameters"),
      noHeaders(
          *this, "noHeaders",
          "Do not print any informational messages at the top of the output"),
      noColumnNames(*this, "noColumnNames",
                    "Do not print column names at the top of the output"),
      doNotPrintBandwidth(*this, "doNotPrintBandwidth",
                          "Make every results that are normally in [GB/s] to "
                          "be printed in [us]"),
      dumpErrorsImmediately(*this, "dumpErrorsImmediately",
                            "print errors to stdout immediately after they "
      ...
      returnSubmissionTimeInsteadOfWorkloadTime(
          *this, "forceSubmissionProfiling",
          "Overrides profiling to return submission time instead of workload "
          "time"),
      markTimers(*this, "markTimers",
                 "Provides prints around Timer Start & End"),
      measurePower(*this, "measurePower",
                   "Measures power and energy in supported benchmarks"),
      ...
      reducedSizeCAL(*this, "reducedSizeCAL",
                     "Run benchmark with lower buffer size") {
...
bool Configuration::parseArgumentsForConfiguration(
...
void Configuration::loadDefaultConfiguration() {
  DEVELOPER_WARNING_IF(Configuration::instance != nullptr,
                       "Configuration parsed multiple times");
  Configuration::instance = std::make_unique<Configuration>();
}

Configuration &Configuration::get() {
  FATAL_ERROR_IF(Configuration::instance == nullptr,
                 "Configuration was not parsed");
