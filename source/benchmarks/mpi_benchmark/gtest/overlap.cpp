...
[[maybe_unused]] static const inline RegisterTestCase<MpiOverlap>
    registerTestCase{};

class MpiOverlapTest
    : public ::testing::TestWithParam<std::tuple<
          uint32_t, UsmMemoryPlacement, UsmMemoryPlacement, bool, uint32_t>> {};
...
INSTANTIATE_TEST_SUITE_P(
    MpiOverlapTest, MpiOverlapTest,
    ::testing::Combine(::testing::Values(1u << 8, 1u << 14, 1u << 20),
