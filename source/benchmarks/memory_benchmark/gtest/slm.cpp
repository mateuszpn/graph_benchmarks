...
[[maybe_unused]] static const inline RegisterTestCase<SlmTraffic>
    registerTestCase{};

class SlmTrafficTest
...
INSTANTIATE_TEST_SUITE_P(SlmTrafficTest, SlmTrafficTest,
                         ::testing::Combine(::testing::Values(8 * kiloByte),
