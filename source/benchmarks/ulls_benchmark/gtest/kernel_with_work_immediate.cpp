...
[[maybe_unused]] static const inline RegisterTestCase<KernelWithWorkImmediate>
    registerTestCase{};

class KernelWithWorkSubmissionImmediateTest
    : public ::testing::TestWithParam<
          std::tuple<WorkItemIdUsage, size_t, size_t, bool>> {};
...
INSTANTIATE_TEST_SUITE_P(
    ...
    KernelWithWorkSubmissionImmediateTest,
    ::testing::Combine(::testing::Values(WorkItemIdUsage::None,
