...
[[maybe_unused]] static const inline RegisterTestCase<ReadAfterAtomicWrite>
    registerTestCase{};

class ReadAfterAtomicWriteTest
...
INSTANTIATE_TEST_SUITE_P(ReadAfterAtomicWriteTest, ReadAfterAtomicWriteTest,
