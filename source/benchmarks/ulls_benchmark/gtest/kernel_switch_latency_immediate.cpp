...
[[maybe_unused]] static const inline RegisterTestCase<
    KernelSwitchLatencyImmediate>
    registerTestCase{};

class KernelSwitchLatencyImmediateTest
    : public ::testing::TestWithParam<
          std::tuple<Api, size_t, size_t, bool, bool, bool, bool, bool>> {};
...
INSTANTIATE_TEST_SUITE_P(
    KernelSwitchLatencyImmediateTest, KernelSwitchLatencyImmediateTest,
    ::testing::Combine(::CommonGtestArgs::allApis(), ::testing::Values(64),
                       ::testing::Values(200), ::testing::Values(false, true),
