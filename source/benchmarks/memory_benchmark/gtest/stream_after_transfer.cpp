...
[[maybe_unused]] static const inline RegisterTestCase<StreamAfterTransfer>
    registerTestCase{};

class StreamAfterTransferTest
    : public ::testing::TestWithParam<
          std::tuple<StreamMemoryType, size_t, bool>> {};
...
INSTANTIATE_TEST_SUITE_P(
    StreamAfterTransferTest, StreamAfterTransferTest,
    ::testing::Combine(
        ::testing::ValuesIn(StreamMemoryTypeArgument::onlyReadAndTriad),
        ::testing::Values(1 * megaByte, 16 * megaByte, 64 * megaByte,
