...
[[maybe_unused]] static const inline RegisterTestCase<UsmCopyImmediate>
    registerTestCase{};

class UsmCopyImmediateTest
    : public ::testing::TestWithParam<
          std::tuple<Api, DeviceSelection, DeviceSelection, DeviceSelection,
...
INSTANTIATE_TEST_SUITE_P(
    UsmCopyImmediateTest, UsmCopyImmediateTest,
