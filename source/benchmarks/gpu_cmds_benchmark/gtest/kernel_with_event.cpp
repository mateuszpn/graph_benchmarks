...
[[maybe_unused]] static const inline RegisterTestCase<KernelWithEvent>
    registerTestCase{};

class KernelWithEventTest
...
INSTANTIATE_TEST_SUITE_P(KernelWithEventTest, KernelWithEventTest,
