...
struct ExecuteCommandListImmediateCopyQueueArguments
  ...
  ExecuteCommandListImmediateCopyQueueArguments()
      : isCopyOnly(*this, "IsCopyOnly",
                   "If true, Copy Engine is selected. If false, Compute Engine "
                   "is selected"),
        measureCompletionTime(*this, "MeasureCompletionTime",
...
struct ExecuteCommandListImmediateCopyQueue
    : TestCase<ExecuteCommandListImmediateCopyQueueArguments> {
  ...
  std::string getHelp() const override {
    return "measures time spent in appending memory copy for immediate command "
           "list on CPU with Copy Queue.";
  }
};
