...
[[maybe_unused]] static const inline RegisterTestCase<OneLocalAtomic>
    registerTestCase{};

class OneLocalAtomicTest
    : public ::testing::TestWithParam<
          std::tuple<DataType, MathOperation, size_t, bool, TestType>> {};
...
INSTANTIATE_TEST_SUITE_P(
    OneLocalAtomicTest, OneLocalAtomicTest,
...
INSTANTIATE_TEST_SUITE_P(
    OneLocalAtomicExtendedTest, OneLocalAtomicTest,
    ::testing::Combine(::testing::Values(DataType::Float, DataType::Int32),
