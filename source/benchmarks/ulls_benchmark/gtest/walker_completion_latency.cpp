...
[[maybe_unused]] static const inline RegisterTestCase<WalkerCompletionLatency>
    registerTestCase{};

class WalkerCompletionLatencyTest
    : public ::testing::TestWithParam<std::tuple<Api, bool, bool>> {};
...
INSTANTIATE_TEST_SUITE_P(WalkerCompletionLatencyTest,
