...
[[maybe_unused]] static const inline RegisterTestCase<AppendLaunchKernel>
    registerTestCase{};

class AppendLaunchKernelTest : public ::testing::TestWithParam<
                                   std::tuple<size_t, size_t, bool, uint32_t>> {
};
...
INSTANTIATE_TEST_SUITE_P(AppendLaunchKernelTest, AppendLaunchKernelTest,
                         ::testing::Combine(::testing::Values(1, 1000),
