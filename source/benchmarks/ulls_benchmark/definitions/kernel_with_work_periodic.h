...
struct KernelWithWorkPeriodicArguments : TestCaseArgumentContainer {
  ...
  KernelWithWorkPeriodicArguments()
      : timeBetweenSubmissions(*this, "timeBetweenSubmissions",
                               "Delay between kernel enqueues in microseconds"),
        numSubmissions(*this, "numSubmissions",
                       "Number of kernel enqueues to run") {}
};
...
struct KernelWithWorkPeriodic : TestCase<KernelWithWorkPeriodicArguments> {
  ...
  std::string getHelp() const override {
    return "measures average time required to run a GPU kernel which assigns "
           "constant values to "
