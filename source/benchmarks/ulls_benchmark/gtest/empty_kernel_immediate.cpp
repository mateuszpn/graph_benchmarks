...
[[maybe_unused]] static const inline RegisterTestCase<EmptyKernelImmediate>
    registerTestCase{};

class EmptyKernelSubmissionImmediateTest
...
INSTANTIATE_TEST_SUITE_P(EmptyKernelSubmissionImmediateTest,
                         EmptyKernelSubmissionImmediateTest,
                         ::testing::Combine(::CommonGtestArgs::workgroupCount(),
