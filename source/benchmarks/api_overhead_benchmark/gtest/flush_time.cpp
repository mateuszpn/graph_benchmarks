...
[[maybe_unused]] static const inline RegisterTestCase<FlushTime>
    registerTestCase{};

class FlushTimeTest : public ::testing::TestWithParam<
                          std::tuple<size_t, size_t, bool, bool, size_t>> {};
...
INSTANTIATE_TEST_SUITE_P(FlushTimeTest, FlushTimeTest,
