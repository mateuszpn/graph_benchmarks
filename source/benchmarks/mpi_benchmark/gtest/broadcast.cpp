...
[[maybe_unused]] static const inline RegisterTestCase<MpiBroadcast>
    registerTestCase{};

class MpiBroadcastTest
    : public ::testing::TestWithParam<std::tuple<
          uint32_t, uint32_t, UsmMemoryPlacement, MpiStatisticsType>> {};
...
INSTANTIATE_TEST_SUITE_P(
    MpiBroadcastTest, MpiBroadcastTest,
    ::testing::Combine(
