...
static TestResult run(const StreamMemoryImmediateArguments &arguments,
  ...
  case StreamMemoryType::Read:
    ...
    ASSERT_ZE_RESULT_SUCCESS(
        zeMemAllocDevice(levelzero.context, &deviceAllocationDesc, 16u, 0,
...
static RegisterTestCaseImplementation<StreamMemoryImmediate>
