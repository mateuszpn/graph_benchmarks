...
static TestResult run(const UsmMemoryAllocationArguments &arguments,
  ...
  ASSERT_ZE_RESULT_SUCCESS(UsmHelper::allocate(
      arguments.usmMemoryPlacement, levelzero, arguments.size, &ptr));
...
static RegisterTestCaseImplementation<UsmMemoryAllocation>
