...
[[maybe_unused]] static const inline RegisterTestCase<UnmapBuffer>
    registerTestCase{};

class UnmapBufferTest
    : public ::testing::TestWithParam<
          std::tuple<Api, size_t, BufferContents, bool, MapFlags, bool>> {};
...
INSTANTIATE_TEST_SUITE_P(
    UnmapBufferTest, UnmapBufferTest,
    ::testing::Combine(::CommonGtestArgs::allApis(),
                       ::testing::Values(128 * megaByte, 512 * megaByte),
                       ::testing::Values(BufferContents::Zeros),
                       ::testing::Values(false, true),
                       ::testing::Values(MapFlags::Read, MapFlags::Write,
                                         MapFlags::WriteInvalidate),
                       ::testing::Values(true)));
