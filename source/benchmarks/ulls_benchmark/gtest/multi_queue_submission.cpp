...
[[maybe_unused]] static const inline RegisterTestCase<MultiQueueSubmission>
    registerTestCase{};

class MultiQueueSubmissionTest
...
INSTANTIATE_TEST_SUITE_P(MultiQueueSubmissionTest, MultiQueueSubmissionTest,
