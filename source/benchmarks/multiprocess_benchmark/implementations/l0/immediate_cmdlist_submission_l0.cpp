...
static TestResult
run(const MultiProcessImmediateCmdlistSubmissionArguments &arguments,
  ...
  // Prepare processes
  ProcessGroup processes{"immediate_cmdlist_walker_submission_workload_l0",
                         arguments.numberOfProcesses};
...
static RegisterTestCaseImplementation<MultiProcessImmediateCmdlistSubmission>
