...
[[maybe_unused]] static const inline RegisterTestCase<
    ExecuteCommandListWithInidrect>
    registerTestCase{};

class ExecuteCommandListTestWithIndirectTest
    : public ::testing::TestWithParam<std::tuple<size_t, UsmMemoryPlacement>> {
};
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ExecuteCommandListTestWithIndirectTest,
    ::testing::Combine(::testing::Values(0u, 10u, 100u, 1000u),
