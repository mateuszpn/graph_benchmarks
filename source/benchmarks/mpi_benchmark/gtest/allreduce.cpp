...
[[maybe_unused]] static const inline RegisterTestCase<MpiAllReduce>
    registerTestCase{};

class MpiAllReduceTest
    : public ::testing::TestWithParam<
          std::tuple<uint32_t, uint32_t, UsmMemoryPlacement, UsmMemoryPlacement,
                     MpiStatisticsType>> {};

TEST_P(MpiAllReduceTest, Test) {
  MpiAllReduceArguments args{};
...
INSTANTIATE_TEST_SUITE_P(
    MpiAllReduceTest, MpiAllReduceTest,
    ::testing::Combine(
