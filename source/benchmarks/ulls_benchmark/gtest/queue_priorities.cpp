...
[[maybe_unused]] static const inline RegisterTestCase<QueuePriorities>
    registerTestCase{};

class QueuePrioritiesTest
    : public ::testing::TestWithParam<
          std::tuple<Api, size_t, bool, size_t, size_t, size_t>> {};
...
INSTANTIATE_TEST_SUITE_P(QueuePrioritiesTest, QueuePrioritiesTest,
