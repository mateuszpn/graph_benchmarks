...
[[maybe_unused]] static const inline RegisterTestCase<OneAtomic>
    registerTestCase{};

class OneAtomicTest
    : public ::testing::TestWithParam<
          std::tuple<DataType, MathOperation, CommonGtestArgs::EnqueueSize,
                     bool, TestType>> {};
...
INSTANTIATE_TEST_SUITE_P(
    OneAtomicExtendedTest, OneAtomicTest,
    ::testing::Combine(::testing::Values(DataType::Float, DataType::Int32),
