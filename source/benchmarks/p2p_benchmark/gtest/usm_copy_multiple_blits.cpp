...
[[maybe_unused]] static const inline RegisterTestCase<UsmCopyMultipleBlits>
    registerTestCase{};

class UsmCopyMultipleBlitsTest
    : public ::testing::TestWithParam<
          std::tuple<Api, size_t, size_t, size_t, std::bitset<9>>> {};
...
INSTANTIATE_TEST_SUITE_P(
    UsmCopyMultipleBlitsTest, UsmCopyMultipleBlitsTest,
    ::testing::Combine(::CommonGtestArgs::allApis(), ::testing::Values(0, 1),
                       ::testing::Values(0, 1),
                       ::testing::Values(512 * megaByte),
                       ::testing::Values("000000001", "000000010", "000000110",
                                         "111111111")));
