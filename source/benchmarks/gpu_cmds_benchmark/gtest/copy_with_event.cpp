...
[[maybe_unused]] static const inline RegisterTestCase<CopyWithEvent>
    registerTestCase{};

class CopyWithEventTest
...
INSTANTIATE_TEST_SUITE_P(CopyWithEventTest, CopyWithEventTest,
                         ::testing::Combine(::testing::Values(500),
