  ...
  MpiAllReduceArguments()
      : mpiLauncher(*this, "mpiLauncher",
        ...
        sendType(*this, "sendType",
                 "Memory type of the MPI_Allreduce send buffer"),
        recvType(*this, "recvType",
                 "Memory type of the MPI_Allreduce recv buffer") {
    mpiLauncher = "mpirun";
...
struct MpiAllReduce : public TestCase<MpiAllReduceArguments> {
  ...
  std::string getTestCaseName() const override { return "MpiAllReduce"; }

  std::string getHelp() const override {
    return "Measures the performance of the all-reduction operation in an "
           "MPI+X application.";
  }
};
