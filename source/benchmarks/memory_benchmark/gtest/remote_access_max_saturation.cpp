...
[[maybe_unused]] static const inline RegisterTestCase<RemoteAccessMaxSaturation>
    registerTestCase{};

class RemoteAccessMaxSaturationTest
    : public ::testing::TestWithParam<
          std::tuple<Api, size_t, size_t, bool, size_t, uint32_t>> {};
...
INSTANTIATE_TEST_SUITE_P(
    RemoteAccessMaxSaturationTest, RemoteAccessMaxSaturationTest,
    ::testing::Combine(::CommonGtestArgs::allApis(),
                       ::testing::Values(1, 2, 4, 6, 8, 10, 20, 50, 100, 0),
                       ::testing::Values(1 * gigaByte), ::testing::Values(true),
                       ::testing::Values(64),
                       ::testing::Values(1u, 4u, 8u, 16u, 32u, 64u, 128u, 256u,
                                         512u, 1024u)));
