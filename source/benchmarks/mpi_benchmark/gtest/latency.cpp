...
[[maybe_unused]] static const inline RegisterTestCase<MpiLatency>
    registerTestCase{};

class MpiLatencyTest : public ::testing::TestWithParam<
                           std::tuple<uint32_t, UsmMemoryPlacement,
