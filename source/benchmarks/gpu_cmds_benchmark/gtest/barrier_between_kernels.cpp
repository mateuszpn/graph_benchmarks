...
[[maybe_unused]] static const inline RegisterTestCase<BarrierBetweenKernels>
    registerTestCase{};

class BarrierBetweenKernelsTest
    : public ::testing::TestWithParam<
          std::tuple<size_t, UsmMemoryPlacement, size_t, size_t>> {};
...
INSTANTIATE_TEST_SUITE_P(
    BarrierBetweenKernelsTest, BarrierBetweenKernelsTest,
    ::testing::Combine(
        ::testing::Values(0, 1),
        ::testing::Values(UsmMemoryPlacement::Device, UsmMemoryPlacement::Host),
        ::testing::Values(0, 1),
        ::testing::Values(4, 8, 16, 32, 64, 256, 1024, 4096, 8192, 16384, 32768,
