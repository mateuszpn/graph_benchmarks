...
static TestResult run(const UsmFillArguments &arguments,
  ...
  // Create buffer
  void *buffer = UsmHelperOcl::allocate(arguments.bufferPlacement, opencl,
  ...
  for (auto i = 0u; i < arguments.iterations; i++) {
    ...
    ASSERT_CL_SUCCESS(clEnqueueMemFillINTEL(
        opencl.commandQueue, buffer, pattern.get(), arguments.patternSize,
...
static RegisterTestCaseImplementation<UsmFill>
