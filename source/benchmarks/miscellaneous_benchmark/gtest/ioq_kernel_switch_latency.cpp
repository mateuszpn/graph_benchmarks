...
[[maybe_unused]] static const inline RegisterTestCase<IoqKernelSwitchLatency>
    registerTestCase{};

class IoqKernelSwitchLatencyTest
...
INSTANTIATE_TEST_SUITE_P(IoqKernelSwitchLatencyTest, IoqKernelSwitchLatencyTest,
