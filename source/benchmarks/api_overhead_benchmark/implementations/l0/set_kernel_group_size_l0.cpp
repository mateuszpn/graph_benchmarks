...
static TestResult run(const SetKernelGroupSizeArguments &arguments,
  ...
  // Create kernel
  auto spirvModule =
      FileHelper::loadBinaryFile("api_overhead_benchmark_write_sum_local.spv");
...
static RegisterTestCaseImplementation<SetKernelGroupSize>
