...
[[maybe_unused]] static const inline RegisterTestCase<MemcpyExecute>
    registerTestCase{};

class MemcpyExecuteTest
    : public ::testing::TestWithParam<
          std::tuple<Api, bool, size_t, size_t, size_t, bool, bool, bool>> {};
...
INSTANTIATE_TEST_SUITE_P(
    MemcpyExecuteTest, MemcpyExecuteTest,
