...
struct ImmediateCommandListSubmission
    : TestCase<ImmediateCommandListSubmissionArguments> {
  ...
  std::string getHelp() const override {
    return "measures submission latency of AppendLaunchKernel issued from "
           "multiple threads to Immediate Command Lists."
           "'threadsPerEngine' count of threads submit commands to each engine."
           "If 'numberOfThreads' is greater than 'threadsPerEngine' x engine "
           "count, then the excess threads are "
