...
[[maybe_unused]] static const inline RegisterTestCase<UsmConcurrentCopy>
    registerTestCase{};

#include <gtest/gtest.h>

class UsmConcurrentCopyTest
    : public ::testing::TestWithParam<std::tuple<Api, size_t, Engine, Engine>> {
};
...
INSTANTIATE_TEST_SUITE_P(
    UsmConcurrentCopyTest, UsmConcurrentCopyTest,
