...
static TestResult run(const EmptyKernelImmediateArguments &arguments,
  ...
  ASSERT_ZE_RESULT_SUCCESS(zeCommandListAppendLaunchKernel(
      cmdList, kernel, &groupCounts, event, 0, nullptr));
  ASSERT_ZE_RESULT_SUCCESS(
...
static RegisterTestCaseImplementation<EmptyKernelImmediate>
