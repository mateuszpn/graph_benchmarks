...
struct SinKernelGraph : TestCase<SinKernelGraphArguments> {
  ...
  std::string getTestCaseName() const override { return "SinKernelGraph"; }

  std::string getHelp() const override {
    return "Benchmark calling sycl::sin kernel & doing mem alloc/dealloc, with "
           "graphs and without graphs";
  }
};
