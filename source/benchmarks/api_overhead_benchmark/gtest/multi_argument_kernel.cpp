...
[[maybe_unused]] static const inline RegisterTestCase<MultiArgumentKernelTime>
    registerTestCase{};

class MultiArgumentKernelTest
...
INSTANTIATE_TEST_SUITE_P(MultiArgumentKernelTest, MultiArgumentKernelTest,
