...
struct EventCtxtSwitchLatencyArguments : TestCaseArgumentContainer {
  ...
  EventCtxtSwitchLatencyArguments()
      : measuredCommands(*this, "measuredCommands",
                         CommonHelpMessage::measuredCommandsCount()),
        firstEngine(*this, "firstEngine",
                    "first engine to measure context switch latency"),
        secondEngine(*this, "secondEngine",
                     "second engine to measure context switch latency") {}
};
...
struct EventCtxtSwitchLatency : TestCase<EventCtxtSwitchLatencyArguments> {
  ...
  std::string getHelp() const override {
    return "measures context switching latency time required to switch between "
