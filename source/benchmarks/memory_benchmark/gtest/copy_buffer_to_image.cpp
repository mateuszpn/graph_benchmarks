...
[[maybe_unused]] static const inline RegisterTestCase<CopyBufferToImage>
    registerTestCase{};

using ImageSize = ThreeComponentUintArgument::TupleType;
class CopyBufferToImageTest
    : public ::testing::TestWithParam<
          std::tuple<Api, ImageSize, UsmMemoryPlacement, size_t, bool, bool>> {
};
...
INSTANTIATE_TEST_SUITE_P(
    CopyBufferToImageTest, CopyBufferToImageTest,
    ::testing::Combine(::CommonGtestArgs::allApis(),
                       ::testing::Values(ImageSize(8192, 1, 1),  // 1D
