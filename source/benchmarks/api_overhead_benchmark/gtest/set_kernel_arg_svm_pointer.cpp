...
[[maybe_unused]] static const inline RegisterTestCase<SetKernelArgSvmPointer>
    registerTestCase{};

class SetKernelArgSvmPointerTest
    : public ::testing::TestWithParam<std::tuple<Api, size_t, bool, size_t>> {};
...
INSTANTIATE_TEST_SUITE_P(SetKernelArgSvmPointerTest, SetKernelArgSvmPointerTest,
