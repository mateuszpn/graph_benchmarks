...
[[maybe_unused]] static const inline RegisterTestCase<QueueMemcpy>
    registerTestCase{};

class QueueMemcpyTest
    : public ::testing::TestWithParam<
          std::tuple<UsmMemoryPlacement, UsmMemoryPlacement, size_t>> {};
...
INSTANTIATE_TEST_SUITE_P(
    QueueMemcpyTest, QueueMemcpyTest,
