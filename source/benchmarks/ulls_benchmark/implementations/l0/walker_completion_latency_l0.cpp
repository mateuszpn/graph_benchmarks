...
static TestResult run(const WalkerCompletionLatencyArguments &arguments,
  ...
  for (auto i = 0u; i < arguments.iterations; i++) {
    ...
    *volatileBuffer = 0;
    ...
    ASSERT_ZE_RESULT_SUCCESS(zeCommandQueueExecuteCommandLists(
        levelzero.commandQueue, 1, &cmdList,
        arguments.useFence ? fence : nullptr));
...
static RegisterTestCaseImplementation<WalkerCompletionLatency>
