...
struct MpiBandwidth : public TestCase<MpiBandwidthArguments> {
  ...
  std::string getTestCaseName() const override { return "MpiBandwidth"; }

  std::string getHelp() const override {
    return "Measures the point-to-point uni-directional message passing "
           "bandwidth in an MPI+X application.";
  }
};
