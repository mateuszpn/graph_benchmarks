...
class ExecuteCommandListImmediateCopyQueueTest
    : public ::testing::TestWithParam<
          std::tuple<Api, bool, bool, UsmMemoryPlacement, UsmMemoryPlacement,
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ExecuteCommandListImmediateCopyQueueTest,
    ::testing::Combine(
        ::CommonGtestArgs::allApis(), ::testing::Values(true, false),
        ::testing::Values(false, true),
        ::testing::ValuesIn(UsmMemoryPlacementArgument::limitedTargets),
        ::testing::ValuesIn(UsmMemoryPlacementArgument::limitedTargets),
        ::testing::Values(64 * megaByte), ::testing::Values(false, true),
