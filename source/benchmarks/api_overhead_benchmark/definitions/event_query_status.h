...
struct EventQueryStatusArguments : TestCaseArgumentContainer {
  ...
  EventQueryStatusArguments()
      : eventSignaled(*this, "eventSignaled", "Event will be set as signaled") {
  }
};
...
struct EventQueryStatus : TestCase<EventQueryStatusArguments> {
  ...
  std::string getTestCaseName() const override { return "EventQueryStatus"; }
