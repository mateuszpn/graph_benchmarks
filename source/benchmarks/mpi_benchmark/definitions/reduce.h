  ...
  MpiReduceArguments()
      : mpiLauncher(*this, "mpiLauncher",
        ...
        sendType(*this, "sendType",
                 "Memory type of the MPI_Reduce send buffer"),
        recvType(*this, "recvType",
                 "Memory type of the MPI_Reduce recv buffer") {
    mpiLauncher = "mpirun";
...
struct MpiReduce : public TestCase<MpiReduceArguments> {
  ...
  std::string getTestCaseName() const override { return "MpiReduce"; }

  std::string getHelp() const override {
    return "Measures the performance of the reduction operation in an MPI+X "
           "application.";
  }
};
