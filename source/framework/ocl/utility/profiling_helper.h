...
inline cl_int getEventDurationInNanoseconds(cl_event &profilingEvent,
                                            cl_ulong &timeNs) {
  cl_ulong start{};
  ...
  cl_int retVal = clGetEventProfilingInfo(profilingEvent, firstTimestamp,
  ...
  cl_ulong end{};
  retVal = clGetEventProfilingInfo(profilingEvent, secondTimestamp,
