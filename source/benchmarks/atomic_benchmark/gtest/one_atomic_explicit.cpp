...
[[maybe_unused]] static const inline RegisterTestCase<OneAtomicExplicit>
    registerTestCase{};

class OneAtomicExplicitTest
...
INSTANTIATE_TEST_SUITE_P(
    OneAtomicExplicitTest, OneAtomicExplicitTest,
...
INSTANTIATE_TEST_SUITE_P(
    OneAtomicExplicitExtendedTest, OneAtomicExplicitTest,
    ::testing::Combine(::testing::Values(DataType::Float, DataType::Int32),
