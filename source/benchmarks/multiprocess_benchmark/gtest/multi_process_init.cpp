...
[[maybe_unused]] static const inline RegisterTestCase<MultiProcessInit>
    registerTestCase{};

class MultiProcessInitOverheadTest
    : public ::testing::TestWithParam<std::tuple<uint32_t, int32_t>> {};
...
INSTANTIATE_TEST_SUITE_P(MultiProcessInitOverheadTest,
