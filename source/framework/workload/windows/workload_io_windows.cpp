...
public:
  ...
  void writeSynchronizationChar(char c) override { std::cout << c; }
...
std::unique_ptr<WorkloadIo> WorkloadIo::create(
    [[maybe_unused]] const WorkloadArgumentContainer &arguments) {
