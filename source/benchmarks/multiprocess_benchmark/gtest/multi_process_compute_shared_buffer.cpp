...
[[maybe_unused]] static const inline RegisterTestCase<
    MultiProcessComputeSharedBuffer>
    registerTestCase{};

class MultiProcessComputeSharedBufferTest
    : public ::testing::TestWithParam<
          std::tuple<Api, DeviceSelection, size_t, size_t, bool>> {};
...
INSTANTIATE_TEST_SUITE_P(
    MultiProcessComputeSharedBufferTest, MultiProcessComputeSharedBufferTest,
    ::testing::Combine(
        ...
        ::testing::Values(1, 2, 4), ::testing::Values(1, 300),
