...
[[maybe_unused]] static const inline RegisterTestCase<VirtualMemReserve>
    registerTestCase{};

class VirtualMemReserveTest
...
INSTANTIATE_TEST_SUITE_P(VirtualMemReserveTest, VirtualMemReserveTest,
                         ::testing::Combine(::testing::Values(64 * kiloByte,
                                                              1 * gigaByte,
                                                              3 * gigaByte),
                                            ::testing::Values(true)));
