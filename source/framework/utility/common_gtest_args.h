...
inline auto workgroupCount() { return ::testing::Values(1, 1000, 10000); }

inline auto workgroupSize() { return ::testing::Values(1, 32, 256); }
...
inline auto contextDeviceSelections() {
  return ::testing::Values(DeviceSelection::Root,  // 1. Naive
                           ...
                           DeviceSelection::Tile0 |
                               DeviceSelection::Tile1, // 4. Ninja
                           DeviceSelection::Root | DeviceSelection::Tile0 |
                               DeviceSelection::Tile1); // 5. Convenience
}

inline auto resourceDeviceSelections() {
  return ::testing::Values(DeviceSelection::Root, DeviceSelection::Tile0,
                           DeviceSelection::Tile1);
}

inline auto usmDeviceSelections() {
  return ::testing::Values(
      DeviceSelection::Host,                           // Host
...
inline auto allAtomicMathOperations() {
  return ::testing::Values(
      MathOperation::Add, MathOperation::Sub, MathOperation::Xchg,
      MathOperation::CmpXchg, MathOperation::Inc, MathOperation::Dec,
      MathOperation::Min, MathOperation::Max, MathOperation::And,
      MathOperation::Or, MathOperation::Xor);
}

inline auto reducedAtomicMathOperations() {
  return ::testing::Values(MathOperation::Add, MathOperation::Xchg,
                           MathOperation::Inc, MathOperation::Min,
                           MathOperation::And);
}

inline auto allNormalMathOperations() {
  return ::testing::Values(
      MathOperation::Add, MathOperation::Sub, MathOperation::Div,
      MathOperation::Modulo, MathOperation::Inc, MathOperation::Dec,
      MathOperation::Min, MathOperation::Max, MathOperation::And,
      MathOperation::Or, MathOperation::Xor);
}
...
inline auto enqueueSizesForAtomics() {
  return ::testing::Values(EnqueueSize{1, 1},    // single work item
...
inline auto reducedEnqueueSizesForAtomics() {
  return ::testing::Values(EnqueueSize{32, 64});
}
