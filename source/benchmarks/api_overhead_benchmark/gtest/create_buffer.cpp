...
[[maybe_unused]] static const inline RegisterTestCase<CreateBuffer>
    registerTestCase{};

class CreateBufferTest : public ::testing::TestWithParam<
                             std::tuple<Api, size_t, bool, bool, bool, bool>> {
};
...
INSTANTIATE_TEST_SUITE_P(CreateBufferTest, CreateBufferTest,
