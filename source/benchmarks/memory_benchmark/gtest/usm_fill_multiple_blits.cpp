...
[[maybe_unused]] static const inline RegisterTestCase<UsmFillMultipleBlits>
    registerTestCase{};

class UsmFillMultipleBlitsTest
    : public ::testing::TestWithParam<
          std::tuple<Api, UsmMemoryPlacement, size_t, size_t, BufferContents,
                     std::bitset<9>>> {};
...
INSTANTIATE_TEST_SUITE_P(
    UsmFillMultipleBlitsTest, UsmFillMultipleBlitsTest,
    ::testing::Combine(
        ::CommonGtestArgs::allApis(),
        ::testing::Values(UsmMemoryPlacement::Device),
        ::testing::Values(512 * megaByte), ::testing::Values(1),
