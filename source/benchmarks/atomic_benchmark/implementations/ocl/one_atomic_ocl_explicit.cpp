...
static TestResult run(const OneAtomicExplicitArguments &arguments,
  ...
  const std::string compilerOptions = KernelHelper::getCompilerOptionsExplicit(
      ...
      arguments.scope, otherArguemtnsBufferEntryCount);
...
static RegisterTestCaseImplementation<OneAtomicExplicit>
