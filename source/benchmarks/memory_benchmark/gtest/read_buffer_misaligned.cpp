...
[[maybe_unused]] static const inline RegisterTestCase<ReadBufferMisaligned>
    registerTestCase{};

class ReadBufferMisalignedTest
    : public ::testing::TestWithParam<std::tuple<Api, size_t, size_t, bool>> {};
...
INSTANTIATE_TEST_SUITE_P(ReadBufferMisalignedTest, ReadBufferMisalignedTest,
