...
[[maybe_unused]] static const inline RegisterTestCase<SeparateAtomics>
    registerTestCase{};

class SeparateAtomicsTest
    : public ::testing::TestWithParam<
          std::tuple<DataType, MathOperation, size_t,
...
INSTANTIATE_TEST_SUITE_P(
    SeparateAtomicsTest, SeparateAtomicsTest,
...
INSTANTIATE_TEST_SUITE_P(
    SeparateAtomicsExtendedTest, SeparateAtomicsTest,
    ::testing::Combine(::testing::Values(DataType::Float, DataType::Int32),
