...
[[maybe_unused]] static const inline RegisterTestCase<MultiKernelExecution>
    registerTestCase{};

class MultiKernelExecutionTest
    : public ::testing::TestWithParam<
          std::tuple<Api, size_t, size_t, size_t, size_t, bool, bool>> {};
...
INSTANTIATE_TEST_SUITE_P(
    MultiKernelExecutionTest, MultiKernelExecutionTest,
    ::testing::Combine(::testing::Values(Api::L0), ::testing::Values(100u),
                       ::testing::Values(32u), ::testing::Values(32u),
                       ::testing::Values(1u), ::testing::Values(false),
