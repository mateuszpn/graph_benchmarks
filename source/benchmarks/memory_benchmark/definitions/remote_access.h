...
struct RemoteAccessMemory : TestCase<RemoteAccessMemoryArguments> {
  ...
  std::string getTestCaseName() const override { return "RemoteAccessMemory"; }

  std::string getHelp() const override {
    return "Uses stream memory in a fashion described by 'type' to measure "
           "bandwidth with different"
           "percentages of remote memory access. Triad means two buffers are "
           "read and one is written to."
