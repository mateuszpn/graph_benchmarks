...
struct KernelHelper {
  static MathOperationTestData getDataForKernel(DataType dataType,
                                                MathOperation operation,
                                                size_t totalThreadsCount);
  static std::string getCompilerOptions(DataType dataType,
                                        MathOperation operation,
                                        size_t otherArgumentBufferSize);
  static std::string getCompilerOptionsExplicit(DataType dataType,
                                                MathOperation operation,
...
private:
  static void addAtomicOpMacro(CompilerOptionsBuilder &options,
                               MathOperation operation);
  static void addExplicitAtomicOpMacro(CompilerOptionsBuilder &options,
                                       MathOperation operation,
                                       AtomicMemoryOrder order,
                                       AtomicScope scope);
};
