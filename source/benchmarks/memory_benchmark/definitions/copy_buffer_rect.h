...
struct CopyBufferRectArguments : TestCaseArgumentContainer {
  ...
  CopyBufferRectArguments()
      : size(*this, "size", "Size of the buffer"),
        compressedSource(*this, "srcCompressed",
...
struct CopyBufferRect : TestCase<CopyBufferRectArguments> {
  ...
  std::string getTestCaseName() const override { return "CopyBufferRect"; }

  std::string getHelp() const override {
    return "allocates two OpenCL buffers and measures rectangle copy bandwidth "
           "between them. "
