...
[[maybe_unused]] static const inline RegisterTestCase<MpiStartup>
    registerTestCase{};

class MpiStartupTest
    : public ::testing::TestWithParam<
          std::tuple<uint32_t, bool, int32_t, MpiStatisticsType>> {};
...
INSTANTIATE_TEST_SUITE_P(
    MpiStartupTest, MpiStartupTest,
    ::testing::Combine(
        ::testing::Values(1, 2, 4, 8, 16, 32), ::testing::Bool(),
