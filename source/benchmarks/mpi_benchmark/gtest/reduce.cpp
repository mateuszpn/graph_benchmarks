...
[[maybe_unused]] static const inline RegisterTestCase<MpiReduce>
    registerTestCase{};

class MpiReduceTest : public ::testing::TestWithParam<
                          std::tuple<uint32_t, uint32_t, UsmMemoryPlacement,
                                     UsmMemoryPlacement, MpiStatisticsType>> {};

TEST_P(MpiReduceTest, Test) {
  MpiReduceArguments args{};
