...
static TestResult run(const EventTimeArguments &arguments,
  ...
  ze_event_pool_desc_t eventPoolDesc = {ZE_STRUCTURE_TYPE_EVENT_POOL_DESC,
                                        nullptr, 0, arguments.eventCount};
  auto eventPoolFlags =
      arguments.hostVisible * ZE_EVENT_POOL_FLAG_HOST_VISIBLE |
      arguments.useProfiling * ZE_EVENT_POOL_FLAG_KERNEL_TIMESTAMP;
  ...
  for (auto i = 0u; i < arguments.iterations; i++) {
    ...
    statistics.pushValue(timer.get() / arguments.eventCount,
