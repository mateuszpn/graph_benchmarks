...
struct MatrixMultiplyArguments : TestCaseArgumentContainer {
  ...
  MatrixMultiplyArguments()
      : numberOfElementsX(*this, "numberOfElementsX",
                          "Number of elements in X dimension"),
        numberOfElementsY(*this, "numberOfElementsY",
                          "Number of elements in Y dimension"),
        numberOfElementsZ(*this, "numberOfElementsZ",
...
struct MatrixMultiply : TestCase<MatrixMultiplyArguments> {
  ...
  std::string getTestCaseName() const override { return "VectorSum"; }

  std::string getHelp() const override { return "Performs vector addition"; }
};
